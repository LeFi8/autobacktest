...
- ``spa``          — audit multiple testing using Hansen's SPA
"""
...
def hansen_spa(
    ...
    Verifies whether the best performing candidate configuration significantly
    outperforms the unoptimized baseline, correcting for multiple-testing /
    data-snooping bias.
    """
    ...
    console.print(
        Panel(verdict, title="Statistical Conclusion", border_style="green" if p_consistent <= 0.05 else "yellow")
    )
    console.print("")
