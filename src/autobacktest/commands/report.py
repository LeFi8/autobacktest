...
def _render_leaderboard_table(
    ...
    attempts_in_run: list[dict[str, Any]],
    selected_run_id: str,
) -> None:
    """Build and print the Rich leaderboard table with cost summary."""
    console = Console()
...
def _report_impl(
    ...
    try:
        ...
        _render_leaderboard_table(rows, attempts_in_run, selected_run_id)
    finally:
        store.close()
